...
// public routes Navigates to /app if authenticated
// private routes Navigates to login if not authenticated
const App = () => {
  return (
    <Routes>
      <Route path="/Register" element={<Registeration/>} />
      <Route element={<PublicRoute path="/ForgetPassword" component={ForgetPassword} />}/>
      <Route path="/Login" element = {<Login/>}/>
      {/* <Route element={<PrivateRoute path="/app" element={<AuthnticatedApp/>} />}/> */}

      <Route path="/app" element={<AuthnticatedApp/>} />
      
      {/* future landing page Navigate to app for now */}
